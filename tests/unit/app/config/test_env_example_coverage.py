...
_REQUIRED_GROUPS = {
    ...
    "Langfuse 可观测": ["LANGFUSE_ENABLED", "LANGFUSE_PUBLIC_KEY", "LANGFUSE_SECRET_KEY", "LANGFUSE_HOST", "LANGFUSE_SAMPLE_RATE"],
    "OpenTelemetry": ["OTEL_ENABLED", "OTEL_EXPORTER_OTLP_ENDPOINT", "OTEL_EXPORTER_OTLP_HEADERS", "OTEL_SERVICE_NAME"],
    "可观测性自托管部署": [
